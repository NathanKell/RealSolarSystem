...
avc = {
	...
	"DOWNLOAD" : "https://github.com/KSP-RO/RealSolarSystem/releases/download/{}/RealSolarSystem_{}.zip".format(args.tag[0],args.tag[0]),
	"HOMEPAGE"  : "https://github.com/KSP-RO/RealSolarSystem/",
	"VERSION" :
	{
		"MAJOR" : major,
		"MINOR" : minor,
...
with open("RealSolarSystem.version", "w") as f:
